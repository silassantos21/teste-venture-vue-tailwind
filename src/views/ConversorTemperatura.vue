      ...
      <div class="grid md:grid-cols-2 sm:grid-cols-1 gap-4">
        <div>
          <BaseCard>
            ...
            <input v-model="c" data-type="celsius" type="number" class="focus:outline-none w-full border border-gray px-3 py-2 rounded" placeholder="Temperatura °C"  @change="setC"/>
          </BaseCard>
        </div>
        <div>
          <BaseCard>
            ...
            <input v-model="f" data-type="fahrenheit" type="number" inputmode="decimal" pattern="[0-9]*[.,]?[0-9]*" class="focus:outline-none w-full border border-gray px-3 py-2 rounded" placeholder="Temperatura °F" @change="setF" />
          </BaseCard>
        </div>
      </div>
    </div>
